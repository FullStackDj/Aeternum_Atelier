...
const Hero = () => {
  return (
    <section className='max-padd-container max-xl:mt-8 mb-16'>
      <div
        className='max-padd-container bg-hero bg-cover bg-center bg-no-repeat h-[736px] w-full rounded-tl-3xl rounded-tr-3xl mt-6'>
        <div className='relative max-w-[777px] top-48'>
          <h5 className='flex items-baseline gap-x-2 uppercase text-secondary medium-18'>MODERN COLLECTION <BsFire/>
          </h5>
